...
import { ArrowUpRight, CheckCircle2, Zap, Shield, Users, Compass, Map, Heart } from 'lucide-react';
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Discover your perfect adventure with our TikTok-style quest feed powered by AI.</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: <Compass className="w-6 h-6" />, title: "Swipe to Explore", description: "Vertical scrolling through curated travel quests" },
              { icon: <Map className="w-6 h-6" />, title: "Detailed Itineraries", description: "Flip cards to see full trip breakdowns" },
              { icon: <Heart className="w-6 h-6" />, title: "Save Favorites", description: "Double-tap to save quests you love" },
